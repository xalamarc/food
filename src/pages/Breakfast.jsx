      ...
      <div className='w-full h-screen flex flex-col mt-[100px]'>
        ...
        <div className='w-full h-full bg-mate'>
          ...
          <div className='w-full h-auto bg-papayaWhip flex flex-col items-start p-[20px]'>
            <ul>
              <li className='p-[3px] text-base font-tt font-semibold'>
                1. Lavamos bien los tomates y pelamos, tambien el diente de ajo
                y hervimos en una olla durante 10-15 min
              </li>
              <li className='p-[3px] text-base font-tt font-semibold'>
              ...
              <li className='p-[3px] text-base font-tt font-semibold'>
                ...
                sarten añadimos el aceite de oliva y calentamos a fuego medio.
              </li>
              <li className='p-[3px] text-base font-tt font-semibold'>
                4. Sofreimos la cebolla en la sarten hasta que cambie de color,
                añadimos todos los ingredientes y sofreimos lentamente. En mitad
                de la coccion, colocamos sal y azucar a gusto.
              </li>
              <li className='p-[3px] text-base font-tt font-semibold'>
                5. En otra sarten, colocamos unas gotas de aceite de oliva y
                doramos las tortillas. Una a una, por ambas caras. Las retiramos
                y las reservamos en un ambiente caliente.
              </li>
              <li className='p-[3px] text-base font-tt font-semibold'>
                6. Luego freimos los huevos
              </li>
              <li className='p-[3px] text-base font-tt font-semibold'>
                7. Servimos con encima de las tortillas calientes que servirán a
                modo de plato y perfectas para mojar en el huevo y empujar con
                la salsa de tomate picante que acompañan los huevos fritos
              </li>
            </ul>
          </div>
        </div>
